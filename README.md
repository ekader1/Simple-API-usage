...
->Facade and proxy patterns used 
- Brief (< 5 sentences) description of your overall design
->Application asks a soccer team to user, then displays informations about club(Squad, schedule,etc),  then saves stadium location
in case user wants to go next match of his/her fav. club to send weatherAPI to show 16 day weather forecast of that location. Then countryAPI takes country_code from weatherAPI, to show informations about country such as currency, and capital city to inform user about potential travel.


## KNOWN BUGS AND INCOMPLETE PARTS:
- What parts of the project you were not able to complete
It can show next 5 games of selected team, but right now there are some leagues that have less than 5 match left before winter break. It causes problem for some leagues.
Some country codes registered wrongly in weatherAPI. Such as London registered in USA in weatherAPI.
